function loadHistogram() {
	...
	var groupedData = d3.nest()
		...
		.object(this.data.histogramData);
	...
	var xMin = d3.min(this.data.histogramData, getX);
	var xMax = d3.max(this.data.histogramData, getX);
	...
	var $select2 = $('#histogram-select-subcategory').selectize({
	...
	// Initialize dropdown using selectize.js
	var $select1 = $('#histogram-select-category').selectize({
	...
	var $select3 = $('#histogram-select-metric').selectize({
